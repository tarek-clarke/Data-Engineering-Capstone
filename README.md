...
Project Overview
This repository contains a full-stack data science pipeline designed to predict NHL seasonal standings using historical performance metrics. Developed as a Master’s Capstone project, this research focuses on the "Salary Cap Era"—a period defined by structural parity in professional sports—to determine if secondary performance indicators can reliably forecast future points totals.
